...
import 'package:bridze/screen/diagnosis_middle/diagnosis_middle_6.dart';
import 'package:bridze/widgets/audio_soong.dart';
import 'package:flutter/material.dart';

class MiddleRead51Page extends StatefulWidget {
  const MiddleRead51Page({Key? key}) : super(key: key);

  @override
  State<MiddleRead51Page> createState() => _MiddleRead51PageState();
}

class _MiddleRead51PageState extends State<MiddleRead51Page> {
                    ...
                    child: GestureDetector(
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => const MiddleRead6Page(),
                          ),
                        );
                      },
                      child: Image.asset(
