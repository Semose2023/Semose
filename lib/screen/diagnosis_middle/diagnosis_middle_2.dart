...
import 'package:bridze/screen/diagnosis_middle/diagnosis_middle_3.dart';
import 'package:bridze/widgets/audio_soong.dart';
import 'package:flutter/material.dart';

class MiddleRead2Page extends StatefulWidget {
  const MiddleRead2Page({Key? key}) : super(key: key);

  @override
  State<MiddleRead2Page> createState() => _MiddleRead2PageState();
}

class _MiddleRead2PageState extends State<MiddleRead2Page> {
                    ...
                    child: GestureDetector(
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => const MiddleRead3Page(),
                          ),
                        );
                      },
                      child: Image.asset(
